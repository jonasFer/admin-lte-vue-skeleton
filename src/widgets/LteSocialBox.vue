  ...
  <!-- Box Comment -->
    <div class="box box-widget">
      ...
      <div class="box-footer box-comments">
        <lte-social-box-comment v-for="comment in comments"
          :name="comment.name"
          :profileImage="comment.profileImage"
          :text="comment.text"
          :date="comment.date"
        ></lte-social-box-comment>
      </div>
      <!-- /.box-footer -->
...
<script>
import LteSocialBoxComment from './LteSocialBoxComment'
...
export default {
  ...
  components: {
    'lte-social-box-comment': LteSocialBoxComment
  }
}
