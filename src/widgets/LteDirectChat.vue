    ...
    <div class="box-body">
      ...
      <div class="direct-chat-contacts">
        <ul class="contacts-list">
          <lte-direct-chat-contact v-for="contact in contacts"
            :key="contact.name"
            :name="contact.name"
            :profileImage="contact.profileImage"
            :latestDate="contact.latestDate"
            :latestMessage="contact.latestMessage"
          ></lte-direct-chat-contact>
        </ul>
        <!-- /.contatcts-list -->
      </div>
      <!-- /.direct-chat-pane -->
...
<script>
import VADirectChatItem from './LteDirectChatItem.vue'
import VADirectChatContact from './LteDirectChatContact.vue'

export default {
  name: 'lte-direct-chat',
  props: {
    theme: {
      type: String,
      default: 'primary'
  ...
  components: {
    'lte-direct-chat-item': VADirectChatItem,
    'lte-direct-chat-contact': VADirectChatContact
  }
}
</script>
