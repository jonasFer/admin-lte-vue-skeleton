...
import VAChatBox from '../widgets/LteChatBox.vue'
import VATodoList from '../widgets/LteTodoList.vue'
import VAQuickMail from '../widgets/LteQuickMail.vue'
import VACalendar from '../widgets/LteCalendar.vue'
